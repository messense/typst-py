...
def test_compile_from_dict_multiple_imports():
    ...
    main_content = b'''#import "utils.typ": format_title
...
def test_compile_from_dict_no_main_key_multiple_files_raises():
    """Test that multiple files without a 'main' or 'main.typ' key raises an error."""
    files = {
        "document.typ": b'#import "helper.typ": helper\n#helper()',
        "helper.typ": b'#let helper() = [Helper text]',
    }

    with pytest.raises(RuntimeError, match="Could not determine main file"):
...
def test_compiler_reuse_with_dict_input():
    ...
    files1 = {
        "main.typ": b'#import "lib1.typ": func1\n#func1()',
    ...
    files2 = {
        "main.typ": b'#import "lib2.typ": func2\n#func2()',
...
def test_compile_from_dict_main_without_extension():
    """Test that 'main' key (without .typ) works as main file."""
    files = {
        "main": b'#import "lib.typ": greet\n#greet("World")',
